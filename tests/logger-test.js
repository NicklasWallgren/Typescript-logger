...
var options = new Log.Logger_Options();
// Create a basic console logger
var logger = Log.Logger_Factory.build(0 /* CONSOLE */, options);
// Log a simple message using level info
logger.info("A simple message to be logged");
/**
* Log messages.
*/
// Log a simple object using the info level
logger.info({ "key": "value" });
// Log using log level error
logger.info("A simple message to be logged");
